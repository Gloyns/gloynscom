  ...
  <div class="service-hero">
    ...
    <div class="service-hero__right">
      <div class="service-hero__sidebar">
        <span class="service-hero__sidebar-title">What you get</span>
        <ul class="service-hero__sidebar-list">
          <li>Search landscape analysis</li>
          <li>Competitor gap analysis</li>
          <li>Prioritised SEO roadmap</li>
          <li>Quick wins and long-term plays</li>
          <li>Readout session with your team</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="service-content service-content--tinted">
    ...
    <div class="service-grid">
      ...
      <div class="service-grid__card">
        ...
        <h4 class="service-grid__card-title">Landscape and competitor analysis</h4>
        <p class="service-grid__card-desc">Where you currently rank, where competitors are winning, and where genuine whitespace exists across search.</p>
      </div>
      <div class="service-grid__card">
  ...
  <div class="service-content">
    ...
    <div class="service-audience">
      ...
      <div class="service-audience__card">
        ...
        <p class="service-audience__card-desc">You're about to invest significantly and need to know where search fits in the picture before committing resources.</p>
      </div>
      <div class="service-audience__card">
        <h4 class="service-audience__card-title">Boards and leadership teams</h4>
        <p class="service-audience__card-desc">You need a clear, jargon-free view of where search sits as a growth channel and what it would realistically take to win.</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container">
    <div class="service-proof__inner">
      <div class="service-proof__left">
        <h3 class="service-proof__title">15+ years of knowing where the opportunity actually is.</h3>
        <div class="service-proof__text">
          <p>I've done this across recruitment, real estate, arts media, hospitality, and more. <strong>The landscape analysis doesn't change.</strong> The analytical approach doesn't. I know how to separate genuine opportunity from noise.</p>
        </div>
      </div>
      <div class="service-proof__right">
        ...
        <div class="service-proof__card">
          ...
          <p class="service-proof__card-text">Comprehensive SEO analysis covering technical, content, and competitive dimensions</p>
        </div>
      </div>
    </div>
  </div>
