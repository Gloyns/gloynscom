...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "ImageObject",
      "@id": "https://gloyns.com/about/#primaryimage",
      "url": "https://gloyns.com/images/andrew-gloyns.webp",
      "contentUrl": "https://gloyns.com/images/andrew-gloyns.webp",
      "caption": "Andrew Gloyns"
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://gloyns.com/about/#breadcrumb",
      "itemListElement": [
  ...
  <div class="about-hero">
    ...
    <div class="about-hero__right">
      <div class="about-hero__image">
        <img src="/images/andrew-gloyns.webp" alt="Andrew Gloyns">
      </div>
    </div>
  </div>
</div>
...
<div class="container animate">
  <div class="about-timeline">
    <div class="about-timeline__label">Background</div>
    <div class="about-timeline__body">
      <nav class="about-timeline__nav">
        <div class="about-timeline__nav-item is-active" data-target="timeline-1">
          <span class="about-timeline__nav-dates">2010-2015</span>
          <span class="about-timeline__nav-role">Agency</span>
        </div>
        <div class="about-timeline__nav-item" data-target="timeline-2">
          <span class="about-timeline__nav-dates">2015</span>
          <span class="about-timeline__nav-role">Going independent</span>
        </div>
        <div class="about-timeline__nav-item" data-target="timeline-3">
          <span class="about-timeline__nav-dates">Today</span>
          <span class="about-timeline__nav-role">Where I am now</span>
        </div>
      </nav>
      <div class="about-timeline__content">
        ...
        <div class="about-timeline__entry" id="timeline-2">
          <span class="about-timeline__entry-date">2015</span>
          <h3 class="about-timeline__entry-title">Launching the consultancy</h3>
          <p>I left agency life to build something different. I started a small, high-engagement consultancy focused on working directly with client teams rather than managing work at arm's length. The model was simple: work with fewer clients, have deeper involvement across their business and deliver better results.</p>
          <p>The first clients came quickly and several of them are still with me. That wasn't the plan exactly but it's become something I'm quite proud of. An average client tenure of seven years is 2-3x longer than industry standard.</p>
        </div>
        <div class="about-timeline__entry" id="timeline-3">
...
<div class="about-outside animate">
  <div class="container">
    <div class="about-outside__inner">
      ...
      <div class="about-outside__video">
        <video autoplay muted loop playsinline>
          <source src="/images/ag-goats.webm" type="video/webm">
        </video>
      </div>
    </div>
  </div>
...
{% include section-cta.html %}

<script>
document.addEventListener('DOMContentLoaded', function() {
  var navItems = document.querySelectorAll('.about-timeline__nav-item');
  navItems.forEach(function(item) {
    item.addEventListener('click', function() {
      navItems.forEach(function(n) { n.classList.remove('is-active'); });
      document.querySelectorAll('.about-timeline__entry').forEach(function(e) { e.classList.remove('is-active'); });
      item.classList.add('is-active');
      document.getElementById(item.getAttribute('data-target')).classList.add('is-active');
    });
  });
});
</script>
