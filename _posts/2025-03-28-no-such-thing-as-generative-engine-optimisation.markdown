---
layout: post
title: Is GEO just user-first SEO? Pretty much
description: "Generative Engine Optimisation is the most talked-about topic in search right now. IMO it's 90% the same SEO I've always practised."
date: 2025-03-19 09:30:35 +0500
updated: 2025-05-21 08:00:35 +0500
permalink: /blog/is-geo-aeo-just-user-first-seo/
redirect_from:
...
In the industry there are two camps in whether AI Search requires anything different to classic SEO.

One side positions AI Search as a complex new discipline requiring a new set of tactics and a new way of thinking about search. 

The other says it's just the same as good SEO.

I believe it's about 90% the same as the user-first, product-led SEO I've always practised. The remaining 10% comes down to some nuances of how LLMs work and how they present information vs blue links.
...
## The feedback loop is a lot tighter than previously
...
If an AI surfaces your content and the user skips it, rephrases their question, or gives a thumbs-down, the model learns. This means that even if you find some sort of shortcut to visibility today (and LinkedIn is littered with those hacks), you'll be edited out by tomorrow if your content doesn't actually deliver.
